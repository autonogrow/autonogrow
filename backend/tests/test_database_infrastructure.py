...
def test_legacy_stamp_then_upgrade_preserves_encrypted_data(tmp_path: Path) -> None:
    ...
    with engine.begin() as connection:
        connection.execute(text("DROP TABLE instagram_content_publication_holds"))
        connection.execute(text("DROP TABLE instagram_content_editorial_reviews"))
        connection.execute(text("DROP TABLE instagram_publish_jobs"))
        connection.execute(text("DROP TABLE instagram_content_comments"))
        connection.execute(text("DROP TABLE instagram_content_validations"))
        connection.execute(text("DROP TABLE instagram_content_version_assets"))
        connection.execute(text("DROP TABLE instagram_content_raw_assets"))
        connection.execute(text("DROP TABLE instagram_content_versions"))
        connection.execute(text("DROP TABLE instagram_final_assets"))
        connection.execute(text("DROP TABLE instagram_raw_assets"))
        connection.execute(text("DROP TABLE instagram_contents"))
        connection.execute(text("DROP TABLE instagram_content_settings"))
        ...
        connection.execute(text("DROP TABLE social_content_proposal_signals"))
        connection.execute(text("DROP TABLE social_content_proposals"))

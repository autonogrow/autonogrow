...
@router.post(
    "/api/owner/businesses/{business_slug}/media/logo",
    dependencies=[Depends(require_owner), Depends(require_business_operational_status)],
)
...
@router.get(
    "/api/owner/businesses/{business_slug}/media/gallery",
    dependencies=[Depends(require_owner), Depends(require_business_operational_status)],
)
